...
public class ProdutoAlimentar extends Produto {
     ...
     * @param certificacoes
     */
    public ProdutoAlimentar(String codigo, String nome, String descricao, int quantidade,double valorUnitario, boolean isBiologico, boolean isVinho, TipoTaxa tipoTaxa,ArrayList<Certificacao> certificacoes) {
