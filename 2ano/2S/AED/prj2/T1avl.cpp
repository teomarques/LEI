...
/*
template <typename T> meaning: 
template will catch all instances of T and replace with the type you provide when you create an instance of the class.
This is a way to make a class that can work with any type of data, not just one specific type.
*/
...
private:
    ...
    // function to get the balance factor (FE) of a node
...
// source: https://www.geeksforgeeks.org/cpp-program-to-implement-avl-tree/
